...
(function(globalScope) {
    ...
    function B(n, base = 10) {
        ...
        P.cosine = P.cos = function() {
            ...
            const r = new B(cosine(angles ? arith(arith(arith(P.toB().n, PI, "m"), "180", "d"), "180", "mod") : arith(P.toB().n, PI, "mod"))).toB(P.b);
        ...
        P.sine = P.sin = function() {
            ...
            // If angle is in grades transform to radians
            const r = new B(sine(angles ? arith(arith(arith(P.toB().n, PI, "m"), "180", "d"), "180", "mod") : arith(P.toB().n, PI, "mod"))).toB(P.b);
        ...
        P.tangent = P.tan = function() {
            ...
            // If angle is in grades transform to radians
            const radians = angles ? arith(arith(arith(P.toB().n, PI, "m"), "180", "d"), "180", "mod") : arith(P.toB().n, PI, "mod");
